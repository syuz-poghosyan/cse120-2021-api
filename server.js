...
const uri =
  "mongodb+srv://Syuzanna-admin:MongodbSyuz2021_@cluster0.hzwax.mongodb.net/cse120-2021-db"
...
app.post('/data/update', function (req, res) {
  ...
  .then(client => {
    ...
    const query = { "_id": ObjectId(id)};
    client.db('cse120-2021-db').collection('books').findoneandupdate(query, req.body.value)
      .then(result => {
        console.log(result)
